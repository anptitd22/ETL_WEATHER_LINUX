...
from dags.spark.build_spark import get_spark, write_spark, write_spark_iceberg
...
def extract_data_weather() -> dataframe:
...
def transform_data_weather(df: dataframe) -> dataframe:
...
def load_data_weather(df: dataframe) -> None:
    print("load data")
    ...
    try:
        ...
        #Ghi thêm vào Iceberg (trên MinIO)
        write_spark_iceberg(df, "events")
